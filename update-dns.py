...
os.system('aws route53 list-resource-record-sets --hosted-zone-id ' + my_hosted_zone_id + ' --query "ResourceRecordSets[?Type == \'A\']" >/home/elliot/update-dns/output.txt 2>/home/elliot/update-dns/errors.txt')
...
with open('/home/elliot/update-dns/record-set-template.json') as myfile:
...
f = open('/home/elliot/update-dns/new-record-set.json', 'w')
f.write(my_json)
f.close()

# Update route 53 with the batch command using the new json file created above
os.system('aws route53 change-resource-record-sets --hosted-zone-id Z2L2TMCJU3N9X3 --change-batch file:///home/elliot/update-dns/new-record-set.json &>/home/elliot/update-dns/dns-record-change.output')
